/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fef2805f6bedc3db4d9f9328f7f53ca8)
// Runtime types generated with workerd@1.20260301.1 2025-09-27 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		CREATOR: "U09EFB5G6TS";
		PERMS_GROUP: "S01E4DN8S0Y";
		GITHUB_LINK: "https://github.com/2wiceUponATime/anonymouse";
		SLACK_BOT_TOKEN: string;
		SLACK_SIGNING_SECRET: string;
		ID_TRANSFORM_SECRET: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CREATOR" | "PERMS_GROUP" | "GITHUB_LINK" | "SLACK_BOT_TOKEN" | "SLACK_SIGNING_SECRET" | "ID_TRANSFORM_SECRET">> {}
}
